/**
 * HVRCRVX_LINGO - Quality Engine Module
 *
  ...
  _exportJsonLD() {
    ...
    const jsonld = {
      '@context': {
        ...
        'hvrcrvx_lingo': 'https://hvrcrvx_lingo.dev/ontology#',
      },
      '@type': 'ontolex:Lexicon',
      '@id': `hvrcrvx_lingo:${this.language.name}`,
      'hvrcrvx_lingo:seed': this.language.seed,
      'hvrcrvx_lingo:version': '3.1',
      ...
      'entries': entries.slice(0, 500).map(entry => ({
        ...
        'hvrcrvx_lingo:field': entry.field,
      })),
    };
...
\\author{Generated by HVRCRVX_LINGO v3.1}
\\date{\\today}
